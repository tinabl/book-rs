...
books= pd.read_csv('https://media.githubusercontent.com/media/tinabl/book-rs/main/books.csv', on_bad_lines='skip')
ratings= pd.read_csv('https://media.githubusercontent.com/media/tinabl/book-rs/main/Ratings.csv')
